...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--latents_train_path', default=r"/root/autodl-tmp/mapper/train_faces.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--latents_test_path', default=r"/root/autodl-tmp/mapper/test_faces.pt", type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--workers', default=90, type=int, help='Number of train dataloader workers')
		...
		self.parser.add_argument('--stylegan_weights', default=r'/root/autodl-tmp/pretrained_models/stylegan2-ffhq-config-f.pt', type=str, help='Path to StyleGAN model weights')
		self.parser.add_argument('--stylegan_size', default=1024, type=int)
		self.parser.add_argument('--ir_se50_weights', default=r'/root/autodl-tmp/pretrained_models/model_ir_se50.pth', type=str, help="Path to facial recognition network used in ID loss")
		...
		self.parser.add_argument('--embedding_dim', type=int,default=512)
